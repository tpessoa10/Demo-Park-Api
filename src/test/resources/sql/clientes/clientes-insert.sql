...
insert into USUARIOS (id, username, password, role) values (103, 'toby@email.com', '$2a$12$pqF/g1QoNtXkEPJnEJg/YuA/rUPpB0jgsX2oKpleQVt7lP6OYuwV6', 'ROLE_CLIENTE');

insert into CLIENTES (id, nome, cpf, id_usuario) values (10, 'Bianca Silva', '81896035078' , 101);
insert into CLIENTES (id, nome, cpf, id_usuario) values (20, 'Roberto Gomes', '74536942050' , 102);